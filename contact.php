...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="gold">Contact us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    MAIN ROAD , pitapuram<br>kakinada 534101<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 1234567890</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">example***@gmail.com</a>
                </p>
